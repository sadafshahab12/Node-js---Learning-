...
const requestHandler = (req, res) => {
  ...
  if (req.url === "/") {
    ...
    req.on("end", () => {
      ...
      console.log(bodyObj);
      //❌ fs.writeFileSync("user.txt", JSON.stringify(bodyObj)); //after parsing create user file //object write into file // write file sync block everything until this executes
